...
ifeq ($(CONFIG_NOVATEK_CS_SETUP),true)
        KERNEL_CFLAGS += CONFIG_NOVATEK_CS_SETUP=y
endif

ifneq ($(CONFIG_NOVATEK_CS_SETUP_TIME),)
	KERNEL_CFLAGS += CONFIG_NOVA_CS_SETUP_TIME=$(CONFIG_NOVATEK_CS_SETUP_TIME)
        KBUILD_OPTIONS += CONFIG_NOVA_CS_SETUP_TIME=$(CONFIG_NOVATEK_CS_SETUP_TIME)
endif

ifeq ($(CONFIG_INPUT_HIGH_RESOLUTION_4),true)
        KERNEL_CFLAGS += CONFIG_INPUT_HIGH_RESOLUTION_4=y
        KBUILD_OPTIONS += CONFIG_INPUT_HIGH_RESOLUTION_4=y
endif
...
ifeq ($(CONFIG_INPUT_NOVA_MULTI_SUPPLIER),true)
...
ifeq ($(CONFIG_NOVA_LOG_CAPTURE),true)
        KERNEL_CFLAGS += CONFIG_NOVA_LOG_CAPTURE=y
        KBUILD_OPTIONS += CONFIG_NOVA_LOG_CAPTURE=y
endif
...
LOCAL_MODULE := nova_0flash_mmi_v3.ko
