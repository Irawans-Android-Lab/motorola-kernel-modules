...
ifeq ($(FOCALTECH_STOWED_MODE_SUPPORT),true)
	KERNEL_CFLAGS += CONFIG_FTS_STOWED_MODE_SUPPORT=y
endif

ifeq ($(FOCALTECH_ESDCHECK_ENABLE),true)
...
ifeq ($(CONFIG_FOCAL_FW_DOWNLOAD_OLD),true)
        KERNEL_CFLAGS += CONFIG_FOCAL_FW_DOWNLOAD_OLD=y
endif
...
ifeq ($(CONFIG_FOCALTECH_CS_SETUP),true)
        KERNEL_CFLAGS += CONFIG_FOCALTECH_CS_SETUP=y
endif

ifeq ($(CONFIG_FOCALTECH_LOG_CAPTURE),true)
        KERNEL_CFLAGS += CONFIG_FOCALTECH_LOG_CAPTURE=y
        KBUILD_OPTIONS += CONFIG_FOCALTECH_LOG_CAPTURE=y
endif
...
LOCAL_MODULE := focaltech_0flash_mmi_v3.ko
