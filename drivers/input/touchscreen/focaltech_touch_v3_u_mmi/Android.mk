...
ifneq ($(FOCALTECH_TOUCH_IC_NAME),)
	...
	KBUILD_OPTIONS += CONFIG_INPUT_FOCAL_IC_NAME=ft3681
endif
...
ifneq ($(FTS_SUPPORT_HIRES_X),)
	KBUILD_OPTIONS += CONFIG_SUPPORT_FTS_HIRES_X=$(FTS_SUPPORT_HIRES_X)
else
...
ifeq ($(FTS_INPUT_PROTOCOL_V0),true)
	KBUILD_OPTIONS += CONFIG_FTS_INPUT_PROTOCOL_V0=y
endif
...
ifeq ($(FTS_POWER_PMU_CONTROL),true)
	KBUILD_OPTIONS += CONFIG_FTS_POWER_PMU_CONTROL=y
endif
...
ifneq ($(FOCALTECH_TOUCH_IC_NAME),)
	...
	KERNEL_CFLAGS += CONFIG_INPUT_FOCAL_IC_NAME=ft3681
endif
...
ifeq ($(FTS_POWER_PMU_CONTROL),true)
	KERNEL_CFLAGS += CONFIG_FTS_POWER_PMU_CONTROL=y
endif
...
ifeq ($(FOCALTECH_REPORT_PRESSURE_DISABLE),true)
	KERNEL_CFLAGS += CONFIG_FOCALTECH_REPORT_PRESSURE_DISABLE=y
endif

endif

include $(CLEAR_VARS)
LOCAL_MODULE := focaltech_touch_v3_u_mmi.ko
