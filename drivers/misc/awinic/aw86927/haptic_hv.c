...
#define HAPTIC_HV_DRIVER_VERSION	"v1.5.0"

char *aw_ram_name = "haptic_ram.bin";
char aw_rtp_name[][AW_RTP_NAME_MAX] = {
	{"aw8693x_rtp.bin"},
	{"aw8693x_rtp_Argo_Navis.bin"},
	{"aw8693x_rtp_Attentive.bin"},
	{"aw8693x_rtp_Awake.bin"},
	{"aw8693x_rtp_Bird_Loop.bin"},
	{"aw8693x_rtp_Brilliant_Times.bin"},
	{"aw8693x_rtp_Chimey_Phone.bin"},
	{"aw8693x_rtp_Complex.bin"},
	{"aw8693x_rtp_Crazy_Dream.bin"},
	{"aw8693x_rtp_Curve_Ball_Blend.bin"},
	{"aw8693x_rtp_Digital_Phone.bin"},
	{"aw8693x_rtp_Electrovision.bin"},
	{"aw8693x_rtp_Ether_Shake.bin"},
	{"aw8693x_rtp_Fateful_Words.bin"},
	{"aw8693x_rtp_Flutey_Phone.bin"},
	{"aw8693x_rtp_Future_Funk.bin"},
	{"aw8693x_rtp_Future_Hi_Tech.bin"},
	{"aw8693x_rtp_Girtab.bin"},
	{"aw8693x_rtp_Hello.bin"},
	{"aw8693x_rtp_Hexagon.bin"},
	{"aw8693x_rtp_Hydra.bin"},
	{"aw8693x_rtp_Insert_Coin.bin"},
	{"aw8693x_rtp_Jumping_Dots.bin"},
	{"aw8693x_rtp_Keys.bin"},
	{"aw8693x_rtp_Loopy.bin"},
	{"aw8693x_rtp_Loopy_Lounge.bin"},
	{"aw8693x_rtp_Modular.bin"},
	{"aw8693x_rtp_Momentum.bin"},
	{"aw8693x_rtp_Morning.bin"},
	{"aw8693x_rtp_Moto.bin"},
	{"aw8693x_rtp_Natural.bin"},
	{"aw8693x_rtp_New_Player.bin"},
	{"aw8693x_rtp_Onward.bin"},
	{"aw8693x_rtp_Organ_Dub.bin"},
	{"aw8693x_rtp_Overclocked.bin"},
	{"aw8693x_rtp_Pegasus.bin"},
	{"aw8693x_rtp_Pyxis.bin"},
	{"aw8693x_rtp_Regrade.bin"},
	{"aw8693x_rtp_Scarabaeus.bin"},
	{"aw8693x_rtp_Sceptrum.bin"},
	{"aw8693x_rtp_Simple.bin"},
	{"aw8693x_rtp_Solarium.bin"},
	{"aw8693x_rtp_Sparse.bin"},
	{"aw8693x_rtp_Terrabytes.bin"},
	{"aw8693x_rtp_Zero_Hour.bin"},
	{"aw8693x_rtp_Play.bin"},
	{"aw8693x_rtp_TJINGLE.bin"},
	{"aw8693x_rtp_Verizon_Airwaves.bin"},
	{"aw8693x_rtp_City_Lights.bin"},
	{"aw8693x_rtp_Firefly.bin"},
	{"aw8693x_rtp_Now_or_Never.bin"},
...
static void richtap_update_fifo_data(struct aw_haptic *aw_haptic, uint32_t fifo_len)
{
	...
	do
	{
		if (aw_haptic->curr_buf->status == MMAP_BUF_DATA_VALID) {
			...
			if((retry-- <= 0) || !atomic_read(&aw_haptic->richtap_rtp_mode)) {
				...
				aw_err("aac richtap invalid data or stop retry %d\n", retry);
				return;
	...
	aw_dbg("richtap_update_fifo_data data %d,samples_left = %d\n", pos, samples_left);
}
...
static void richtap_rtp_work(struct work_struct *work)
{
	...
	aw_info("richtap_rtp_work rtp 1837 tm_len = %d\n", tmp_len);

	if (tmp_len <= 0)
		return;
	if (richtap_rtp_start(aw_haptic)) {
		aw_info("richtap_rtp_work start richtap play\n");
		pm_qos_enable(aw_haptic, true);
		...
		while(aw_haptic->curr_buf->status != MMAP_BUF_DATA_FINISHED) {
			...
			if ((glb_state_val & AW_GLBRD_STATE_MASK) == AW_STATE_STANDBY) {
				aw_err("debugrichtap work break\n");
				break;
			}
		}
		atomic_set(&aw_haptic->richtap_rtp_mode, false);
...
static int richtap_file_open(struct inode *inode, struct file *file)
{
	...
	if (file->f_op->check_flags(1) == LEFT_FOPS) {
		...
		aw_err("richtap_file_open: file private_data err!");
	}
#else
