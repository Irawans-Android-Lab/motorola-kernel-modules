...
static void aw8624x_play_stop(struct aw_haptic *aw_haptic)
{
	...
	haptic_nv_i2c_write_bits(aw_haptic, AW8624X_REG_PLAYCFG3, AW8624X_BIT_PLAYCFG3_PLAY_MODE_MASK,
...
static int aw8624x_offset_cali(struct aw_haptic *aw_haptic)
{
	...
	if (aw_haptic->info.is_enabled_smart_loop)
		return 0;
	...
	d2s_gain = aw8624x_select_d2s_gain(aw_haptic->info.f0_d2s_gain);
	if (d2s_gain <= 0) {
...
static void aw8624x_get_lra_resistance(struct aw_haptic *aw_haptic)
{
	...
	d2s_gain_default = (~AW8624X_BIT_SYSCTRL5_D2S_GAIN_MASK) & reg_val;
	haptic_nv_i2c_write_bits(aw_haptic, AW8624X_REG_SYSCTRL5,
				 AW8624X_BIT_SYSCTRL5_D2S_GAIN_MASK,
				 AW8624X_BIT_SYSCTRL5_D2S_GAIN_10);
	d2s_gain = aw8624x_select_d2s_gain(AW8624X_BIT_SYSCTRL5_D2S_GAIN_10);
	if (d2s_gain <= 0) {
		aw_err("d2s_gain is error");
		return;
	}
